...
cmd({
    pattern: "menu",
    desc: "Display LONATI-XMD Command Menu",
    category: "main",
    filename: __filename
}, async (conn, m, { reply }) => {
    try {
        // System Info
        const dateNow = moment().tz('South/Africa').format('dddd, MMMM Do YYYY, HH:mm:ss');
        const upTime = runtime(process.uptime());
        const botName = "LONATI-XMD";
        const ownerName = "THUGKEED-TECH";
