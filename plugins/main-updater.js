...
cmd({
  ...
  alias: ["upgrade", "sync"],
  react: '🧠',
  desc: "Update LONATI-XMD bot from GitHub.",
  category: "system",
  filename: __filename
  ...
  try {
    await reply("🔎 Checking for LONATI-XMD updates...");

    const repo = "Thugkeedxxx/LONATI-XMD";
    ...
    if (latestHash === currentHash) {
      return reply("✅ You are already using the latest version of LONATI-XMD!");
    }
    ...
    const sourcePath = path.join(extractPath, "LONATI-XMD-main");
